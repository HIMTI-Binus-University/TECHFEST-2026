...
const Hero = () => {
  ...
  return(
    <section className="relative bg-[#00113B] w-full h-screen flex overflow-hidden flex-col items-center justify-center">
      ...
      {/*Techfest text*/}
      <div className="relative z-30 flex flex-col items-center space-y-5 md:space-y-7 mt-16 md:mt-32 text-center">
        <div className="px-1 pt-2 pb-6 text-5xl sm:text-7xl lg:text-[124px] font-black bg-gradient-to-b from-[#FF5481] to-[#FFAF08] bg-clip-text text-transparent whitespace-nowrap leading-[0.9] drop-shadow-[0_0_25px_rgba(249,115,22,0.6)]"
        style={{ fontFamily: 'BTTF' }}>
          TECHFEST
        </div>
        {/*placeholder subtext*/}
        <p
          className="text-[16px] md:text-[20px] font-medium text-[#05BADD] max-w-2xl text-center leading-relaxed tracking-wider"
        ...
        {/*button + link*/}
        <Link 
        to="https://bit.ly/RegistrationTechfest2026"
